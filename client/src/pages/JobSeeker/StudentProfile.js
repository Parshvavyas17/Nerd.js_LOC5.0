          ...
          <div className="container rounded-2xl bg-lightPurple min-w-full min-h-full p-8 shadow-md">
            <form>
              <div className="flex flex-col min-w-full min-h-full mb-6">
                ...
                <div className="flex flex-row">
                  ...
                  <input
                    type="text"
                    name="firstName"
                    className="rounded-xl border border-purple w-56 p-1"
                    onChange={handlefNameChange}
                  />
                  <input
                    type="text"
                    name="lastName"
                    className="rounded-xl border border-purple w-56 p-1 ml-5"
              ...
              <div className="flex flex-row-reverse min-w-full min-h-full mt-4">
                <button
                  type="submit"
                  className="flex-reverse align border bg-purple rounded-xl w-24 p-2 text-white font-semibold"
