    ...
    <div className="bg-[#40189D] w-full min-h-screen h-full flex font-ourfont">
      ...
      <div className="bg-[#F2F2F2] w-full h-screen px-10 pt-4 ml-10 rounded-l-3xl flex justify-center items-center">
        <div className="flex flex-col w-1/2 h1/2">
          ...
          <div className="container rounded-2xl bg-lightPurple min-w-full min-h-full p-12 shadow-main-sd">
            <form>
              <div className="flex flex-col min-w-full min-h-full mb-4">
                <label className="mb-5 font-bold text-xl">
                  Add your work sample links here if any:
                </label>
              ...
              <div className="flex flex-col min-w-full min-h-full mb-4">
                <label className="mb-1 font-medium">
                  Playstore Developer Account Link:
                </label>
                <div className="flex flex-row flex-wrap justify-between">
                  <input
                    type="text"
                    className="rounded-xl border border-purple w-96 p-1"
                    onChange={handlePlaystoreLink}
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col min-w-full min-h-full mb-4">
                ...
                <div
                  ...
                  onChange={handleOtherPortfolioLink}
                >
                  <input
                    type="text"
                    className="rounded-xl border border-purple w-96 p-1"
              ...
              <div className="flex flex-row-reverse min-w-full min-h-full mt-10 justify-evenly">
                <button
                  type="submit"
                  className=" bg-purple rounded-xl text-white p-3 px-10"
