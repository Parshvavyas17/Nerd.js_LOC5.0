...
const Navbar = () => {
    return (
        <div>
            {/* left */}
            <div className="header h-24 bg-white  grid grid-cols-3 shadow-lg hover:shadow-xl ">
                <div className="image">
                    <img src='#' alt="logo" className="h-16 ml-10 px-10 mt-4 cursor-pointer"></img>
                </div>
                {/* Middle */}
                ...
                {/* right */}
                <div className=" flex justify-end items-center w-56 h-10 mt-10 space-x-8">
